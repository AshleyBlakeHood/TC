...
public class DiplomaticMarket : MonoBehaviour
{
	...
	void Start ()
	{
		guns [0] = new Gun ("Freedom Cannon", 12, 56, 175, 50, 2.23f, 4, 12, "Large", 250, 1, 46, false, 0, 60, "USA", 1, 2, null);
		guns [1] = new Gun ("Assault Eagle", 12, 56, 175, 50, 2.23f, 4, 12, "Large", 250, 1, 46, false, 0, 60, "USA", 1, 2, null);
		guns [2] = new Gun ("Walmart", 12, 56, 175, 50, 2.23f, 4, 12, "Small", 250, 1, 46, true, 0, 60, "USA", 1, 2, null);
